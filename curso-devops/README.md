...
1. Fluxo: Otimizar o fluxo de trabalho da esquerda (desenvolvimento) para a direita (operações/cliente).
   ...
   - reduzir o número de tranferências
   - identificar e eliminar gargalos no fluxo de valor
   - eliminar desperdícios no fluxo de valor
2. Feedback: Criar ciclos curtos de feedback para identificar e corrigir problemas rapidamente.
   - observabilidade para coleta e exibição de dados do fluxo
   - desenvolvimento baseado em hipóteses e testes
   - identificar e resolver problemas logo no início (testes funcionais)
   - construir conhecimento com base nos problemas
3. Aprendizado e Experimentação: Fomentar uma cultura de alto risco e aprendizagem constante
   - cultura organizacional baseada em um gestão sem medo e sem culpa
